...
<div id="main">
    ...
    <input type="text" id="districtname" name="districtname" placeholder="Your districtname.." required="" value="<%=disid%>" >
    ...
    <th>Edit</th>
          ...
          <% String p="select * from tbl_district d inner join tbl_state s on d.state_id=s.state_id";
                ...
                <tr> 
                    ...
                    <td><%=disnam%></td>
                    <td><a href ="District.jsp?delid=<%=r3.getString("dis_id")%>"><img src="../../Admin/taxi/Design/Icon/delete5.jfif" width="35" height="35"></a></td>
                    <td><a href ="District.jsp?edtid=<%=r3.getString("dis_id")%>"><img src="../../Admin/taxi/Design/Icon/edit3.jfif" width="35" height="35"></a></td>
                </tr>
                <% i++;
