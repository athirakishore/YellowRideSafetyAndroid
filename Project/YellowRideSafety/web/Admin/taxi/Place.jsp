...
<div id="main">
    ...
    <input type="text" id="placename" name="placename" placeholder="Your placename.." required="" value="<%=placeid%>">
    ...
    <th>EDIT</th>
          ...
          <% String p="select * from tbl_place p inner join tbl_district d on p.dis_id =d.dis_id inner join tbl_state s on d.state_id= s.state_id";
                ...
                <tr> 
                    ...
                    <td><a href ="Place.jsp?delid=<%=r3.getString("place_id")%>"><img src="../../Admin/taxi/Design/Icon/delete5.jfif" width="35" height="35"></a></td>
                    <td><a href ="Place.jsp?edtid=<%=r3.getString("place_id")%>"><img src="../../Admin/taxi/Design/Icon/edit3.jfif" width="35" height="35"></a></td>
                </tr>
                <% i++;
